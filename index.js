...
class ReviewManager {
    ...
    addComment(line, text) {
        var comment = new Comment(line, this.currentUser, new Date(), text)
        if (this.activeComment) {
    ...
    * iterateComments(comments, depth, countByLineNumber) {
        ...
        for (var i = comments.length - 1; i >= 0; i--) {
            ...
            countByLineNumber[comment.line] = (countByLineNumber[comment.line] || 0) + 1
            yield { depth, comment, count: countByLineNumber[comment.line] }            
